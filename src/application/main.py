...
import src.infrastructure.db.models.db_comment  # noqa:  F401
import src.infrastructure.db.models.db_evaluation  # noqa:  F401
import src.infrastructure.db.models.db_meeting  # noqa:  F401
import src.infrastructure.db.models.db_task  # noqa:  F401
import src.infrastructure.db.models.db_team  # noqa:  F401
...
def create_app() -> FastAPI:
    ...
    # static и templates внутри application/
...
if __name__ == "__main__":
    uvicorn.run(
        "src.application.main:fastapi_app",
        host="127.0.0.1",
        port=8001,
        log_level="info",
        reload=True,
