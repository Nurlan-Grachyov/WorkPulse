...
class TaskRepository(Protocol):
    ...
    async def add_task(self, task: Task, user_id: UUID) -> tuple[User | None, User | None, Task | None]: ...

    async def update_task(self, task_slug: str, user_id: UUID,) -> tuple[User, Task]: ...

    async def delete_task(self, task: Task, user_id: UUID) -> tuple[User, Task]: ...
